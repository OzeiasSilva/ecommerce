...
class User extends Model {
	...
	const SESSION = "User";
	const SECRET = "HcodePhp8_Secrect_lab";
	const SECRET_IV = "HcodePhp7_Secret_IV";
	const ERROR = "UserError";
	const ERROR_REGISTER = "UserErrorRegister";
	const SUCCESS = "UserSucesss";

	//Função para verificar se a sessão existe, se o ID do usuário é maior que ZERO
	...
	public static function checkLogin($inadmin = true){
		...
		if (
			...
			return false;
			 ...
			 //Verifica se é uma rota da administração
			if($inadmin === true && (bool)$_SESSION[User::SESSION]["inadmin"] === true){

				return true;
						
			} else if($inadmin == false){  //Se não foi uma rota da administração
